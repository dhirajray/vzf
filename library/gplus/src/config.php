...
if ($_SERVER['SERVER_NAME'] == 'localhost') {
  $config = new Zend_Config_Ini(APPLICATION_PATH . '/configs/application.ini', 'local');
}else {
...
$apiConfig = array(
    ...
    'oauth2_client_id' => gplusClientappid,
    'oauth2_client_secret' => gplusClientSecret,
    'oauth2_redirect_uri' => gplusRedierctUrl,

    // The developer key, you get this at https://code.google.com/apis/console
    'developer_key' => '377138436066',
    ...
    'oauth_consumer_key'    => 'new.dbee.me',
    'oauth_consumer_secret' => 'LoeslXWolXrJ0uSnpWOWC4Lx',
  
    // Site name to show in the Google's OAuth 1 authentication screen.
    'site_name' => 'new.dbee.me',
