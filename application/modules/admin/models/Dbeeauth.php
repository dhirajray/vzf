...
class Admin_Model_Dbeeauth  extends Zend_Db_Table_Abstract
{
     // Table name 
     protected $_name = 'tblClient';
	...
	public function fetchallclient()
	{
		...
		$select->from(array('a'=>'tblClient'),array('*'))		
		->order('clientID DESC')->limit(25);
  ...
  public function insertresource($table,$dataval)
  {
    ...
    public function autofill($clientID_define)
    {
      ...
      /***************%*******************/
          ...
          $returnidval1 = $this->insertresource('resources',$dataval1);
      /***************%%******************/
          $data2 = array(    
          ...
          $returnid2 = $this->insertresource('tblResourcesManage',$data2)+1;
      ...
      /*****************%*****************/
          ...
          $returnidval2 = $this->insertresource('resources',$dataval2);
      /*****************%%****************/
          ...
          $returnid3 = $this->insertresource('tblResourcesManage',$data3)+1;

      /***************%*******************/
          $dataval3 = array(    
                      array('clientID' =>$clientID,'module'=>'admin','controller'=>'event','action'=>'index','res_id'=>$returnid3+1),
            );
          $returnidval3 = $this->insertresource('resources',$dataval3);
      /*****************%%****************/
          ...
          $returnid4 = $this->insertresource('tblResourcesManage',$data4)+1;
      /***************%*******************/
          $dataval4 = array(    
          ...
          $returnidval4 = $this->insertresource('resources',$dataval4);
      /*****************%%****************/
          $data5 = array(
          ...
          $returnid5 = $this->insertresource('tblResourcesManage',$data5)+1;
      /***************%*******************/
          $dataval5 = array(    
          ...
          $returnidval5 = $this->insertresource('resources',$dataval5);
      /*****************%%****************/
          $data6 = array(
                    array('clientID' =>$clientID,'resource'=>'VIP Users','status'=>0,'parent_id'=>0),
                    array('clientID' =>$clientID,'resource'=>'VIP User Accounts','status'=>0,'parent_id'=>$returnid5),
                    array('clientID' =>$clientID,'resource'=>'VIP User Types','status'=>0,'parent_id'=>$returnid5),
                    array('clientID' =>$clientID,'resource'=>'VIP User Groups','status'=>0,'parent_id'=>$returnid5),
          );
          $returnid6 = $this->insertresource('tblResourcesManage',$data6)+1;
      /***************%*******************/
          $dataval6 = array(    
                      array('clientID' =>$clientID,'module'=>'admin','controller'=>'usergroup','action'=>'listing','res_id'=>$returnid6+1),
            );
          $returnidval6 = $this->insertresource('resources',$dataval6);
      /*****************%%****************/
          $data7 = array(
          ...
          $returnid7 = $this->insertresource('tblResourcesManage',$data7)+1;
      /***************%*******************/
          $dataval7 = array(    
          ...
          $returnidval7 = $this->insertresource('resources',$dataval7);
      /*****************%%****************/
          $data8 = array(
                    array('clientID' =>$clientID,'resource'=>'Reports','status'=>1,'parent_id'=>0),
                    array('clientID' =>$clientID,'resource'=>'Reports','status'=>1,'parent_id'=>$returnid7),
          ...
          $returnid8 = $this->insertresource('tblResourcesManage',$data8)+1;
      /***************%*******************/
          $dataval8 = array(    
                      array('clientID' =>$clientID,'module'=>'admin','controller'=>'message','action'=>'index','res_id'=>$returnid8+1),
            );
          $returnidval8 = $this->insertresource('resources',$dataval8);
      /*****************%%****************/
          $data9 = array(
          ...
          $returnid9 = $this->insertresource('tblResourcesManage',$data9)+1;
      /***************%*******************/
          $dataval9 = array(    
                      array('clientID' =>$clientID,'module'=>'admin','controller'=>'knowledgecenter','action'=>'index','res_id'=>$returnid9+1),
            );
          $returnidval9 = $this->insertresource('resources',$dataval9);
      /*****************%%****************/
          $data10 = array(
          ...
          $returnid10 = $this->insertresource('tblResourcesManage',$data10)+1;
      /***************%*******************/
          $dataval10 = array(    
          ...
          $returnidval10 = $this->insertresource('resources',$dataval10);
      /*****************%%****************/
          $data11 = array(
          ...
          $returnid11 = $this->insertresource('tblResourcesManage',$data11)+1;
      /***************%*******************/
          $dataval11 = array(    
          ...
          $returnidval11 = $this->insertresource('resources',$dataval11);
      /*****************%%****************/
          $data12 = array(
          ...
          $returnid12 = $this->insertresource('tblResourcesManage',$data12)+1;
      /***************%*******************/
          $dataval12 = array(    
          ...
          $returnidval12 = $this->insertresource('resources',$dataval12);
      /*****************%%****************/
          $data13 = array(
          ...
          $returnid13 = $this->insertresource('tblResourcesManage',$data13)+1;
      /***************%*******************/
          $dataval13 = array(    
                      array('clientID' =>$clientID,'module'=>'admin','controller'=>'myaccount','action'=>'configuration','res_id'=>$returnid13+1),
            );
          $returnidval13 = $this->insertresource('resources',$dataval13);
      /*****************%%****************/
          $data14 = array(
          ...
          $returnid14 = $this->insertresource('tblResourcesManage',$data14)+1;
